...
Adventure races are categorized primarily by time, not distance. This page summarizes common race lengths and how checkpoint order/scoring works across formats.
...
- **Terrain**: Often in local parks or accessible wilderness areas
- **Navigation**: Basic map and compass skills required
...
- **Navigation**: More complex route choices and checkpoint locations
...
- **Navigation**: Complex navigation with numerous checkpoints
...
Different race formats handle checkpoint order and scoring in different ways:

- **Linear races**: Teams must visit CPs in a specific order
- **Rogaine/Score-O format**: Teams choose which CPs to collect within the time limit, with optional CPs worth different point values
- **Mixed format**: Combination of both styles with some mandatory CPs

---

Back to the overview: [Introduction](/content/introduction.md)
